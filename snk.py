...
bgmg=pygame.transform.scale(bgmg,(500,600))
...
start = False
pygame.mixer.music.load("9394_pubg_bgm_ringtone.mp3")
...
while not start :
	...
	bgimg=pygame.transform.scale(bgimg,(500,600))
	win.fill((0,0,0))
	win.blit(bgimg,(0,0))
	text_screen("made by Kanishka Srivastava",(0,100,100),335,747)
...
while run:
	...
	if 250>cur[0]>120 and 1100>cur[1]>1000:
		...
		v_x=-5
		v_y=0
	if 595>cur[0]>440 and 1100>cur[1]>1000:
	...
	if (score*10)<snk_len:
		...
		del snk_size[0]
		snk_len -=1
	if x<20 or x>700 or y<20 or y>780:
		game_over=True
